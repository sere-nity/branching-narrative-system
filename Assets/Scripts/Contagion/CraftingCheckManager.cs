...
public static class CraftingCheckManager
{
    ...
    // current response) 
    public static CombinedResponseText HandleResponseText(Response response)
    {
        DialogueEntry destinationEntry = response.destinationEntry;
        string responseText = destinationEntry.subtitleText;
        CombinedResponseText combinedResponseText = new CombinedResponseText(response, responseText);
